...
public class EquestrianRenderer extends GeoEntityRenderer<EquestrianEntity> {
    public EquestrianRenderer(EntityRendererProvider.Context renderManager) {
        ...
        addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            @Nullable
            @Override
            protected ItemStack getStackForBone(GeoBone bone, EquestrianEntity animatable) {
                return switch (bone.getName()) {
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, EquestrianEntity animatable) {
                return switch (bone.getName()) {
            ...
            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone, ItemStack stack, EquestrianEntity animatable, MultiBufferSource bufferSource, float partialTick, int packedLight, int packedOverlay) {
