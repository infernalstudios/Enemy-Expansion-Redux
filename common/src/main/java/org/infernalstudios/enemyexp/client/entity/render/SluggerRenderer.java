...
import org.infernalstudios.enemyexp.client.entity.model.SluggerModel;
...
public class SluggerRenderer extends GeoEntityRenderer<SluggerEntity> {
    public SluggerRenderer(EntityRendererProvider.Context renderManager) {
        ...
        addRenderLayer(new ItemArmorGeoLayer<>(this) {
            @Nullable
            @Override
            protected ItemStack getArmorItemForBone(GeoBone bone, SluggerEntity animatable) {
            ...
            @Override
            protected @NotNull EquipmentSlot getEquipmentSlotForBone(GeoBone bone, ItemStack stack, SluggerEntity animatable) {
                return switch (bone.getName()) {
            ...
            @Override
            protected @NotNull ModelPart getModelPartForBone(GeoBone bone, EquipmentSlot slot, ItemStack stack, SluggerEntity animatable, HumanoidModel<?> baseModel) {
                return switch (bone.getName()) {
            ...
            private ItemStack armorStackForBone(SluggerEntity entity, EquipmentSlot slot) {
        ...
        addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            @Nullable
            @Override
            protected ItemStack getStackForBone(GeoBone bone, SluggerEntity animatable) {
                return switch (bone.getName()) {
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, SluggerEntity animatable) {
                return switch (bone.getName()) {
            ...
            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone, ItemStack stack, SluggerEntity animatable, MultiBufferSource bufferSource, float partialTick, int packedLight, int packedOverlay) {
    ...
    @Override
    public RenderType getRenderType(SluggerEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
