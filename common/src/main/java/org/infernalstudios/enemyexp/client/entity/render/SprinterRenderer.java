...
import org.infernalstudios.enemyexp.client.entity.model.SprinterModel;
...
public class SprinterRenderer extends GeoEntityRenderer<SprinterEntity> {
    public SprinterRenderer(EntityRendererProvider.Context renderManager) {
        ...
        addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            @Nullable
            @Override
            protected ItemStack getStackForBone(GeoBone bone, SprinterEntity animatable) {
                return switch (bone.getName()) {
            ...
            @Override
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, SprinterEntity animatable) {
                return switch (bone.getName()) {
            ...
            @Override
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone, ItemStack stack, SprinterEntity animatable, MultiBufferSource bufferSource, float partialTick, int packedLight, int packedOverlay) {
