...
public class EEntityLootTables extends EntityLootSubProvider {
    ...
    public void generate() {
        ...
        addDefaultZombieLootTable(EEntities.MEATURE.get());
        addDefaultZombieLootTable(EEntities.EQUESTRIAN.get());
